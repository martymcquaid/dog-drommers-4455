...
- **Dev Server URL**: `http://127.0.0.1:5217`
- **Preview URL**: `https://api.chitterchat.co.uk/chipify/projects/aad830b9-ba1e-4a95-8518-cf12b372f2e7/preview`
- **Port**: `5217`
...
4. The dev server is accessible at `http://127.0.0.1:5217`
5. Preview the application using the preview URL: `https://api.chitterchat.co.uk/chipify/projects/aad830b9-ba1e-4a95-8518-cf12b372f2e7/preview`
